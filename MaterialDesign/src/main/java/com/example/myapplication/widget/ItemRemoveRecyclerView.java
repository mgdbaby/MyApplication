        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    DataListAdapter.DataInfoViewHolder viewHolder = (DataListAdapter.DataInfoViewHolder) getChildViewHolder(view);
                    if(viewHolder == null){
                        Log.i("=============", "viewHolder is null");
                    }else {
                        Log.i("=============", "viewHolder is not null");
                    }
                    mItemLayout = viewHolder.linearLayout;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.textDelete);
